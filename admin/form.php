        ...
        if(isset($_FILES['fileToUpload1']) && !empty($_FILES['fileToUpload1']['name'])){
            ...
            // if everything is ok, try to upload file ***tmp_name = C:\xampp\tmp\php1472.tmp***
                ...
                if (move_uploaded_file($_FILES["fileToUpload1"]["tmp_name"], $target_file)) { 
                    ...
                    $sql = "INSERT INTO appointment (ort, appointment_date, image_name)
                    VALUES (?,?,?)";
                    $stmt= $conn->prepare($sql);
                    $stmt->execute([$ort, $date, $new_name]);
                } else {
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Termine erstellen</h1>
                    ...
                    <div class="panel-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Ort</label>
                                <input class="form-control" type="text" name="ort" required>
                            ...
                            <button type="submit" class="btn btn-success" name="termin">Erstellen </button>
                            <p><?= $message1; ?></p>
                        </form>
                    </div>
                </div>
